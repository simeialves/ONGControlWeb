...
const pacotesRouter = express.Router();
const jwt = require("jsonwebtoken");
const bodyParser = require("body-parser");

pacotesRouter.use(bodyParser.json());
...
//READ
pacotesRouter.post("/", verifyJWT, async (req, res, next) => {
...
pacotesRouter.get("/:id", verifyJWT, async (req, res, next) => {
